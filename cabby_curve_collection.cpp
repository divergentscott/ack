...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
CabbyCurveCollection::CabbyCurveCollection(){};

Eigen::Vector2d CabbyCurveCollection::ray_segment_intersect(const Eigen::Vector2d orig,
...
bool CabbyCurveCollection::is_ray_segment_intersect(const Eigen::Vector2d orig,
                                               const Eigen::Vector2d dir,
                                               const Eigen::Vector2d a,
                                               const Eigen::Vector2d b) {
...
bool CabbyCurveCollection::is_point_in(Eigen::Vector2d point) {
...
double CabbyCurveCollection::distance_till_impact(const int pointid,
                                             const Eigen::Vector2d dir) {
...
std::array<int,2> CabbyCurveCollection::neighborhood_orientation(int pointid) {
    /*
...
bool CabbyCurveCollection::orient_curves() {
    /*
...
void CabbyCurveCollection::compute_tangents() {
...
void CabbyCurveCollection::compute_normals() {
    compute_tangents();
...
bool CabbyCurveCollection::insertEdges(const std::vector<std::array<double,2>> &grid_points, const std::vector<std::vector<int>> &one_cells) {
    // Size allocation
...
bool CabbyCurveCollection::insertEdges(const std::vector<std::array<double,3>> &grid_points, const std::vector<std::vector<int>> &one_cells) {
    // Size allocation
    points_.resize(grid_points.size());
    edges_.resize(one_cells.size());
    // Copy the points
...
int CabbyCurveCollection::get_number_of_points() {
    /*Point access*/
    return points_.size();
};

Eigen::Vector2d CabbyCurveCollection::get_point(int p_id) {
    /*Point access*/
    return points_[p_id];
};

Eigen::Vector2d CabbyCurveCollection::get_normal(int p_id) {
    /*Normal access*/
    if (!is_normals_computed_) compute_normals();
    return normals_[p_id];
};

int CabbyCurveCollection::get_next_edge(int e_id){
    return edge_order_next_[e_id];
}

int CabbyCurveCollection::get_prev_edge(int e_id){
    return edge_order_prev_[e_id];
}

int CabbyCurveCollection::get_next_point(int p_id){
    return edge_order_next_[p_id];
}

int CabbyCurveCollection::get_prev_point(int p_id){
    return edge_order_prev_[p_id];
}


std::array<int,2> CabbyCurveCollection::get_points_of_edge(int e_id){
    return edges_[e_id];
}
