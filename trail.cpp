...
//#include "trail.h"
//
//Vedge Zone::getWesternFront() const {
//    Eigen::Vector2d a = landmarks_downtown_.points_[0];
//    Eigen::Vector2d b = landmarks_uptown_.points_[0];
//    return {b,a};
//};
//
//struct RectContact{
...
//
//
//void removeRectangle(std::vector<Zone> &trails, const Eigen::Vector2d& position, const double& width, const double& height){
...
//        const Zone& trail_tt = trails[tt];
//        for (int plat_ii=0; plat_ii < trail_tt.landmarks_downtown_.num_plateaus_; plat_ii++){
//            //
//            Hedge plat = trail_tt.landmarks_downtown_.getPlateau(plat_ii);
...
//                Hedge plat = trl.landmarks_downtown_.getPlateau(platoo);
...
//                    auto lwb = trl.landmarks_downtown_.points_.begin();
//                    double fallto = trl.landmarks_downtown_.points_[rm_end_id][1];
//                    trl.landmarks_downtown_.points_.erase(lwb + rm_start_id, lwb + rm_end_id + 1);
//                    std::vector<Eigen::Vector2d> getin = {
//                        {position[0], position[1]+height},
//                        {position[0]+width, position[1]+height},
//                        {position[0]+width, fallto}
//                    };
//                    trl.landmarks_downtown_.points_.insert(lwb + rm_start_id, getin.begin(), getin.end());
//                    trl.landmarks_downtown_.num_walls_ = (trl.landmarks_downtown_.points_.size()-1)/2;
//                    trl.landmarks_downtown_.num_plateaus_ = (trl.landmarks_downtown_.points_.size())/2;
//                    return;
//                }
//            }
//        };
//        trl.landmarks_downtown_.points_ = newvalley;
//        trl.landmarks_downtown_.num_plateaus_ = (trl.landmarks_downtown_.points_.size()-1)/2;
//        trl.landmarks_downtown_.num_walls_ = (trl.landmarks_downtown_.points_.size())/2;
//    };
//
